// src/pages/docs/Ionic.jsx
import React from "react";
import { Ionicdata } from "@/data/Ionicdata";
...
const MessageBox = ({ type, children }) => {
  ...
  return (
    <div className={`border-l-4 p-3 mt-3 mb-3 rounded ${styles[type]}`}>
...
const CodeBlock = ({ code }) => (
  <div className="flex justify-center">
    <div className="mt-4 bg-slate-900 text-slate-100 p-5 rounded-lg w-full max-w-xl">
      <pre className="text-sm whitespace-pre-wrap text-center">{code}</pre>
    </div>
  </div>
);
...
export const Ionicsdk = () => {
  const { title, subtitle, android, ios } = Ionicdata;
