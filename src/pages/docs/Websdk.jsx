...
import { Webdatasdk } from "@/data/Webdatasdk";

export const Websdk = () => {
  const { title, subtitle, sections } = Webdatasdk;
        ...
        <div key={idx} className="mb-8">
                ...
                >
                  ...
                  {item.code && (
                    <div className="bg-slate-900 text-slate-100 p-4 rounded-lg mb-3">
                      <code className="text-sm whitespace-pre-wrap">{item.code}</code>
                    </div>
                  )}
          ...
          {section.stacked &&
            section.items.map((item, i) => (
              <div
                key={i}
                className="bg-card border border-border p-4 rounded-lg mb-4"
              >
